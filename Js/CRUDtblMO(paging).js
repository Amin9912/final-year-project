...
$(document).ready(function() {
  ...
  $.ajax({
    url: 'retrieveOrderData(CRUD).php',
    method: 'GET',
    dataType: 'json',
...
//Pop up window data show after click delete and edit icon
  ...
  $('.edit').click(function() {
    ...
    $('input[name="OID"]').val(showData);
    $('input[name="CID"]').val(data[i]['custID']);
    $('input[name="shippingID"]').val(data[i]['shippingID']);
    $('select[name="orderStatus"]').val(data[i]['orderStatusPayment']);
  });
