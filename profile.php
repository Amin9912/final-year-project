...
<body>
  ...
  <main>
    ...
    $sqlSelectCust = "SELECT * FROM `admin` WHERE `adminID` = '$userID'";
              ...
              <div class="card-body">
                <div class="account-settings">
                  <div class="user-profile">
                    ...
                    <h5 class="user-name"><?php echo $row["adminName"]; ?></h5>
                    <h6 class="user-email"><?php echo $row["adminEmail"]; ?></h6>
                  </div>
                  <div class="about">
                ...
                <div class="row gutters">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="custFullName" placeholder="Enter full name" value="<?php echo $row["adminName"]; ?>">
                    </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="custEmail">Email</label>
                      <input type="email" class="form-control" id="custEmail" name="custEmail" placeholder="<?php echo $row["adminEmail"]; ?>" disabled>
                    </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      <label for="custPhoneNum">Phone</label>
                      <input type="text" class="form-control" id="custPhoneNum" name="custPhoneNum" placeholder="Enter phone number" value="<?php echo $row["adminPhoneNum"]; ?>">
                    </div>
                  </div>
                </div>
                <div class="row gutters">
